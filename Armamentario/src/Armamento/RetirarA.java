 ...
 * @author basty
 */
public class RetirarA extends javax.swing.JFrame {
    
    private FrameArmas frameArmas;
    /**
     * Creates new form RegistroA
     */
    public RetirarA(FrameArmas frameArmas, String numeroSerie, String retirado) {
        initComponents();
    ...
    private void btnRetirarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRetirarActionPerformed
        ...
        if (rbSi.isSelected()) {
            ...
            JOptionPane.showMessageDialog(this, "No se puede retirar el arma porque no tiene el curso correspondiente.", "Advertencia", JOptionPane.WARNING_MESSAGE);
            this.dispose();
            return;
        } else {
        ...
        boolean exito = logica.retirarArma(numeroSerie, retiradoPor);

        if (exito) {
            JOptionPane.showMessageDialog(this, "Se retiro el arma con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            frameArmas.mostrarArmamento();
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Error al retirar el arma.", "Error", JOptionPane.ERROR_MESSAGE);
        }
